...
function Hero() {
  return (
    <div>
      <div style={{
      ...
      }} className="img h-screen bg-primary flex flex-col md:justify-start justify-end ">
        ...
        <div className=" md:w-[50%] md:py-25 text-primary rounded-lg px-10 py-2 md:px-10 md:bg-transparent md:text-white bg-white md:gap-6 gap-3 flex flex-col">
          ...
          <p className="md:text-xl text-[12px]">Browse, explore, and find the perfect property with our innovative website. Seamlessly connect with sellers, agents, and a vibrant community of home seekers. Your dream home awaits!</p>
